...
require 'env "PATH=${CONTROLLER_TOPLEVEL}/sw/bin:/run/current-system/sw/bin" bash -s --' "installed-boot verification does not use Python from the copied target closure"
