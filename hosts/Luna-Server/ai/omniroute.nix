...
# this module only declares how it runs on Luna-Server.
#
  ...
  nixos.hosts."Luna-Server" =
...

    {
      ...
      sops.secrets.omniroute_api_key = {
        sopsFile = "${inputs.nixos-secrets}/secrets/Luna-Server/hermes-router.yaml";
      ...
      systemd.services.omniroute-container = {
        ...
        serviceConfig = {
          ...
          ExecStart = lib.escapeShellArgs [
            ...
            "--label" "luna-server.role=omniroute"
